...
void main() {
  ...
  classes.forEach((schema, cm) {
    ...
    // print(schema.toJson());
    schemaOutput
      ..write("Map ${MirrorSystem.getName(cm.simpleName).toUpperCase()}_SCHEMA = ")
      ..write(JSON.encode(schema))
      ..writeln(";");
  });
...
class JsonSchemaBuilder {
  ...
  toJson() {
    ...
    return {
        "type": "object", "name": schemaName, "additionalProperties" : true, "properties": propMap
    };
  }
}

...
class Customer extends Syncable<Customer> {
  ...
  Future<List<bool>> updateDatabase(DatabaseHandler dbh, QuickbooksConnector qbc) {
    ...
    if (this.quickbooksName == null || this.quickbooksName.isEmpty) {
      ...
      customer.billAddress.country = "";
      customer.billAddress.state = "";
      customer.billAddress.note = "";
      ...
      customer.shipAddress.city = "";
      customer.shipAddress.postalCode = "";
      customer.shipAddress.country = "";
      customer.shipAddress.state = "";
      customer.shipAddress.note = "";

...
// PurchaseRow Schema: 
Map PURCHASEROW_SCHEMA = {"type":"object","name":"PurchaseRow","additionalProperties":true,"properties":{"amount":{"oneOf":[{"type":"number"},{"type":"null"}]},"cost":{"oneOf":[{"type":"number"},{"type":"null"}]},"purchaseTime":{"type":"integer"},"productID":{"type":"integer"},"weightID":{"oneOf":[{"type":"integer"},{"type":"null"}]},"descriptorID":{"oneOf":[{"type":"integer"},{"type":"null"}]},"packagingID":{"oneOf":[{"type":"integer"},{"type":"null"}]},"supplierID":{"type":"integer"},"collectingHaulierID":{"oneOf":[{"type":"integer"},{"type":"null"}]},"ID":{"type":"integer"},"Uuid":{"type":"string"},"key":{"anyOf":[{"type":"null"},{"type":"boolean"},{"type":"integer"},{"type":"array"},{"type":"number"},{"type":"object"},{"type":"string"}]},"isActive":{"type":"boolean"}}};

// SalesRow Schema: 
Map SALESROW_SCHEMA = {"type":"object","name":"SalesRow","additionalProperties":true,"properties":{"amount":{"oneOf":[{"type":"number"},{"type":"null"}]},"salePrice":{"oneOf":[{"type":"number"},{"type":"null"}]},"customerID":{"type":"integer"},"transportID":{"oneOf":[{"type":"integer"},{"type":"null"}]},"deliveryDate":{"oneOf":[{"type":"integer"},{"type":"null"}]},"groupID":{"oneOf":[{"type":"integer"},{"type":"null"}]},"productID":{"oneOf":[{"type":"integer"},{"type":"null"}]},"weightID":{"oneOf":[{"type":"integer"},{"type":"null"}]},"packagingID":{"oneOf":[{"type":"integer"},{"type":"null"}]},"descriptorID":{"oneOf":[{"type":"integer"},{"type":"null"}]},"deliveryCost":{"oneOf":[{"type":"number"},{"type":"null"}]},"ID":{"type":"integer"},"Uuid":{"type":"string"},"key":{"anyOf":[{"type":"null"},{"type":"boolean"},{"type":"integer"},{"type":"array"},{"type":"number"},{"type":"object"},{"type":"string"}]},"isActive":{"type":"boolean"}}};

// Options Schema: 
Map OPTIONS_SCHEMA = {"type":"object","name":"Options","additionalProperties":true,"properties":{"name":{"type":"string"},"option":{"type":"string"},"ID":{"type":"integer"},"Uuid":{"type":"string"},"key":{"anyOf":[{"type":"null"},{"type":"boolean"},{"type":"integer"},{"type":"array"},{"type":"number"},{"type":"object"},{"type":"string"}]},"isActive":{"type":"boolean"}}};
